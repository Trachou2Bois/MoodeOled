...
- **(Pas testé) Support GPIO et encodeur rotatif** utilisant `lgpio`. Nécessite d'être activé et de configurer les broches dans le config.ini dans la section "manual".
